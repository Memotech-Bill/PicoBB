// ../sym_stubs.c - Stub functions for SDK routines that are otherwise inline
// Automatically generated by header_funcs.py sdk_headers.txt sym_sdk.txt ../sym_stubs.c
// Do not edit
