...
def header_list (sList, sOut, sStub):
    ...
    with open (sList, 'r') as fList, open (sOut, 'w') as fOut, open (sStub, 'w') as fStub:
        fStub.write ('// sym_stubs.c - Stub functions for SDK routines that are otherwise inline\n'
                     '// Automatically generated by header_funcs.py - Do not edit\n\n')
        for sLine in fList:
            sHeader = os.path.join (sSDK, sLine.strip ())
