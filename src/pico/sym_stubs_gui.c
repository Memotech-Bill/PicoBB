// ../sym_stubs_gui.c - Stub functions for SDK routines that are otherwise inline
// Automatically generated by header_funcs.py sdk_headers_gui.txt sym_sdk_gui.txt ../sym_stubs_gui.c
// Do not edit
