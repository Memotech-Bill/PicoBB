// sym_gui.h - Declare functions accessable via SYM
// Automatically generated by merge_funcs.py sym_gui.h symbols/sym_gui_sdk.txt symbols/sym_gui_map.txt
// Do not edit.
...
void dcordic_rot_step (void);
void dcordic_vec_step (void);
void defclr (void);
...
void float_table_shim_on_use_helper (void);
void floorl (void);
void fltcall_ (void);
void fputwc (void);
void fread (void);
...
const symbols sdkfuncs[] = {
    ...
    {"dcordic_rot_step", dcordic_rot_step},
    {"dcordic_vec_step", dcordic_vec_step},
    {"defclr", defclr},
    ...
    {"float_table_shim_on_use_helper", float_table_shim_on_use_helper},
    {"floorl", floorl},
    {"fltcall_", fltcall_},
    {"fputwc", fputwc},
    {"fread", fread},
