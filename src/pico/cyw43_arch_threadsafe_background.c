...
// note same code
#if PICO_CYW43_ARCH_THREADSAFE_BACKGROUND_FIXED

#if PICO_CYW43_ARCH_THREADSAFE_BACKGROUND_FIXED && CYW43_LWIP && !NO_SYS
#error PICO_CYW43_ARCH_THREADSAFE_BACKGROUND_FIXED requires lwIP NO_SYS=1
#endif
#if PICO_CYW43_ARCH_THREADSAFE_BACKGROUND_FIXED && CYW43_LWIP && MEM_LIBC_MALLOC
#error MEM_LIBC_MALLOC is incompatible with PICO_CYW43_ARCH_THREADSAFE_BACKGROUND_FIXED
#endif
